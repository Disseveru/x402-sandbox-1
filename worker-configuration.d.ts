/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d6e15c628a55b14e393656d294fccdd0)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PROTECTED_PATTERNS: [{"pattern":"/v1/company-angle","price":"$0.01","description":"Generate one actionable company outreach or action angle"}];
