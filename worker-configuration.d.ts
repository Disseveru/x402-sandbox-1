/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 7d70bc35183e97d838bd4cdd990c31ea)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PROTECTED_PATTERNS: [{"pattern":"/api/enrich","price":"$0.01","description":"Lead enrichment signals for a target website"},{"pattern":"/api/compliance","price":"$0.02","description":"Heuristic trust/compliance signal detection"},{"pattern":"/api/extract","price":"$0.01","description":"LLM-friendly structured content extraction"}];
